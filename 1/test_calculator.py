...
class TestCalculator(unittest.TestCase):
    def test_result(self):
        self.assertEqual(90.0, calculate_discount(
            purchase_amount=100, discount_amount=10))

    def test_zero_result(self):
        self.assertEqual(0, calculate_discount(
            purchase_amount=0, discount_amount=10))

    def test_zero_discount(self):
        self.assertEqual(100, calculate_discount(
            purchase_amount=100, discount_amount=0))
...
if __name__ == '__main__':
    # verbosity=2 подробный вывод результата теста, кровни от 0-2
