...
class TestVehicle(unittest.TestCase):
    ...
    def test_car_is_instance_of_vehicle(self):
        # isinstance () — это встроенная функция, которая возвращает True, если объект является экземпляром указанного класса или подкласса этого класса, и False в противном случае.
        self.assertTrue(isinstance(self.car, Vehicle))

    def test_four_wheel_car(self):
        # assertEqual для проверки равенства двух значений
